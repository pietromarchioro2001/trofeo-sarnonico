            ...
            <div className="divide-y divide-gray-100">
             {g.teams.map((team, index) => (
              <div key={index} className="flex items-center px-3 py-2">
                ...
                <div className="w-5 text-center text-[10px]">{team.giocate}</div>
                <div className="w-4 text-center text-[10px]">{team.vittorie}</div>
                <div className="w-4 text-center text-[10px]">{team.pareggi}</div>
                <div className="w-4 text-center text-[10px]">{team.sconfitte}</div>
                <div className="w-5 text-center text-[10px]">{team.gol_fatti}</div>
                <div className="w-5 text-center text-[10px]">{team.gol_subiti}</div>
