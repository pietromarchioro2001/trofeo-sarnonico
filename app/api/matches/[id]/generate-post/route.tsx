...
export async function GET(
  ...
  try {
    ...
    // Sostituisci SOLO la parte di dynamicContentPostMatch con questa versione semplificata:
...
const dynamicContentPostMatch = (
  <div style={{ display: 'flex', flexDirection: 'column', width: '100%', height: '100%' }}>
    ...
    <div style={{ position: 'absolute', top: 920, left: 60, right: 60, bottom: 100, background: 'rgba(255,255,255,0.95)', borderRadius: 20, boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>
      ...
      <div style={{ position: 'absolute', left: 60, right: '50%', top: 80, bottom: 40, paddingRight: 40 }}>
      ...
      {/* Lista Marcatori Ospite */}
      <div style={{ position: 'absolute', left: '50%', right: 60, top: 80, bottom: 40, paddingLeft: 40 }}>
