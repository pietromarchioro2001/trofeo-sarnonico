  ...
  try {
    ...
    const dynamicContent = type === 'PRE_MATCH' ? (
      <div style={{ display: 'flex', flexDirection: 'column', width: '100%', height: '100%' }}>
        ...
        <div style={{ position: 'absolute', top: 1480, left: 130, right: 130, display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 80 }}>
        ...
        <div style={{ position: 'absolute', top: 1675, left: 0, right: 0, display: 'flex', justifyContent: 'center' }}>
